...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.runelic', name: 'runelic-neoforge-26.1.2', version: '26.1.2.0'
     // Fabric
     implementation group: 'net.darkhax.runelic', name: 'runelic-fabric-26.1.2', version: '26.1.2.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.runelic', name: 'runelic-common-26.1.2', version: '26.1.2.0'
}
```
